...
const ArBr = () => {
    const contents =[
        {
            video:'https://www.youtube.com/shorts/U00nKYL9UWM',
        ...
        {
            video:'https://youtube.com/shorts/dtV0tsWSqkc?feature=share',
        ...
        {
            video:'https://www.youtube.com/shorts/JcqVJfAHPDo',
        ...
        {
            video:'https://www.youtube.com/watch?v=e0vNiBp85UY',
    ...
    return (
        <div>
           ...
           <section className=''>
                <img className='w-full h-96' src={vr} alt="" />
            </section>
            <section>
                {
