        ...
        <div>
            ...
            <section className='w-11/12 mx-auto'>
                <div className='grid grid-cols-1 my-9 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                    ...
                    <img className='m-2 w-full h-[400px] rounded' src={img1} alt="" />
                    </Link>
                    
                    <Link to={'https://www.instagram.com/p/COPlN5ChCG0/?img_index=1'}>
                    <img className='m-2 w-full h-[400px] rounded' src={img2} alt="" /> 
                    </Link>

                    <Link to={'https://www.instagram.com/p/COaBVxHBNS5/?img_index=1'}> 
                    <img className='m-2 w-full h-[400px] rounded' src={img3} alt="" />
                     </Link>
                    <Link to={'https://www.instagram.com/p/COvMVG6hS7E/?img_index=1'}> 
                    <img className='m-2 w-full h-[400px] rounded' src={img4} alt="" />
                    </Link>

               
                    <img className='m-2 w-full h-[400px] rounded' src={img5} alt="" />
                    <img className='m-2 w-full h-[400px] rounded' src={img6} alt="" />
                    <img className='m-2 w-full h-[400px] rounded' src={img7} alt="" />
                    <img className='m-2 w-full h-[400px] rounded' src={img8} alt="" />
                    <img className='m-2 w-full h-[400px] rounded' src={img9} alt="" />
